...
from uutils.data_utils import ATEPCProcessor, convert_examples_to_features
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if global_step % args.eval_steps == 0:
                    if epoch >= args.num_train_epochs-2 or args.num_train_epochs<=2:
                        ...
                        logger.info('steps {}'.format(nb_tr_steps))
...
def parse_experiments(path):
    ...
    for id, config in json_config.items():
        ...
        parser.add_argument("--train_batch_size", default=int('4'), type=int,
                            help="Total batch size for training.")
        parser.add_argument("--dropout", default=float(config['dropout']), type=int)
        parser.add_argument("--max_seq_length", default=int('40'), type=int)
...
if __name__ == "__main__":
    ...
    experiments.add_argument('--config_path', default='chinese-experiments.json', type=str, help='Path of experiments config file')
